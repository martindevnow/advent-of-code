...
export const add = (argA, argB, argC, app, code) => app[argC] = (isPointer(code, 1) ? app[argA] : argA) + (isPointer(code, 2) ? app[argB] : argB);
export const multiply = (argA, argB, argC, app, code) => app[argC] = (isPointer(code, 1) ? app[argA] : argA) * (isPointer(code, 2) ? app[argB] : argB);
...
export const isTrue = (argA, _, app, code) => (isPointer(code, 1) ? app[argA] : argA) !== 0;
export const isFalse = (argA, _, app, code) => (isPointer(code, 1) ? app[argA] : argA) === 0;
export const lessThan = (argA, argB, argC, app, code) => {
  app[argC] = (isPointer(code, 1) ? app[argA] : argA) < (isPointer(code, 2) ? app[argB] : argB) ? 1 : 0
};
