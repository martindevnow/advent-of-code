...
const answerPart1 = data.reduce((acc, curr) => {
...
console.log('The Answer to Part 1', answerPart1['twos'] * answerPart1['threes']);
...
const isOffByOne = (str1, str2) => {
  const numDiff = [...str1].map((lett, index) => {
...
final = final.join('');
console.log('The Answer to Part 2', final);
